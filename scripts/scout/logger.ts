/**
 * Scout -- Dual-format logger (JSON + human-readable)
 *
 * Mirrors Sentry/Egg logger pattern. Writes to stdout and log files.
 */
...
const minLevel: LogLevel = (process.env.SCOUT_LOG_LEVEL as LogLevel) || 'info';

let logFileReady = false;
const logFilePath = join(PATHS.logDir, 'scout.log');
const jsonLogPath = join(PATHS.logDir, 'scout.jsonl');
