/**
 * Ledger -- Dual-format logger (JSON + human-readable)
 *
 * Mirrors Egg/Sentry logger pattern. Writes to stdout and log files.
 */
...
const minLevel: LogLevel = (process.env.LEDGER_LOG_LEVEL as LogLevel) || 'info';

let logFileReady = false;
const logFilePath = join(PATHS.logDir, 'ledger.log');
const jsonLogPath = join(PATHS.logDir, 'ledger.jsonl');
