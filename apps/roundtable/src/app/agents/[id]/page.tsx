...
import { ArrowLeft, Bot, ShieldCheck, ShieldX, Calendar } from "lucide-react";
      ...
      <div className="rounded-xl border border-pl-border bg-pl-surface p-6">
        ...
        <div className="mt-5 pt-5 border-t border-pl-border">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-lg bg-pl-bg p-3 border border-pl-border">
              <p className="text-xs text-pl-text-dim">Trust Score</p>
              <div className="mt-1 flex items-center gap-2">
                <span className="text-xl font-bold text-pl-text">
                  {agent.trust_score}
                </span>
                <div className="flex-1 h-2 rounded-full bg-pl-border overflow-hidden">
                  <div
            ...
            <div className="rounded-lg bg-pl-bg p-3 border border-pl-border">
              <p className="text-xs text-pl-text-dim">Verification</p>
              <p className="mt-1 text-xl font-bold text-pl-text">
